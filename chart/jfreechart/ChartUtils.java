package com.faithworth.utils.chart.jfreechart;
...
public class ChartUtils {
    ...
    public static void setChartTheme() {
        String fontPath = Thread.currentThread().getContextClassLoader().getResource("/").getPath() + "simsun.ttc";
        Font font = null;
        try {
            font = Font.createFont(Font.PLAIN, new java.io.File(fontPath));
    ...
    public static void setYAixs(CategoryPlot plot) {
        ...
        axis.setAutoRange(true);//自动设置数据轴数据范围
    ...
    public static void setPieRender(Plot plot) {
        ...
        plot.setNoDataMessage(NO_DATA_MSG);
        plot.setInsets(new RectangleInsets(15, 10, 15, 10));
        PiePlot piePlot = (PiePlot) plot;
        piePlot.setInsets(new RectangleInsets(15, 10, 25, 10));
